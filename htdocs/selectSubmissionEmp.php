...
$rez = mysqli_query($conn, "SELECT submissionID FROM pickupassignment WHERE branchID = '$branchID' AND status = 'waiting_for_courier';");
//$subID = mysqli_fetch_array($rez, MYSQLI_ASSOC);
...
echo '</div>';
              ...
              if (isset($_POST['buy_btn'])) {
                            $_SESSION['submissionForCourier'] = $_POST['rowid'];
                            header('Location: AssignCourier.php');
                        }
          ?>
    </div>
  </form>
