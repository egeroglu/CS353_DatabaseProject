...
{    
    ...
    if(!empty($_POST['nameInput']) && !empty($_POST['passwordInput']))
    {
        ...
        $res = mysqli_query($conn, "SELECT * FROM customer WHERE UPPER(username) = '$userID' AND UPPER(password) = '$password';");
...
<body class="body">
    <h1 class="baslik">Customer Log In</h1>
    <div class="jumbotron">
    ...
    <form method="POST">
            ...
            <a href="SignUp.php" class="btn btn-outline-secondary "><i>SignUP?</i></a>
</form>
            </div>
    </div>
